...
current_temperature  = driver.find_element_by_xpath("//span[@id='temperature']").text
time.sleep(3)
...
if int(temperature_only) > 34 :
    print("sunscreen")
    button  = driver.find_element_by_xpath("/html/body/div[1]/div[3]/div[2]/a/button[contains(text(),'Buy sunscreens')]") 
    button.click()
...
#redirecting to the Moisturizers page
    ...
    print("moistriser")
    button  = driver.find_element_by_xpath("/html/body/div[1]/div[3]/div[1]/a/button[contains(text(),'Buy moisturizers')]") 
    button.click()
