...
def enter_details_to_payment(driver):
    ...
    email.send_keys('drishya@qxf2.com')
    time.sleep(1)
    # Enter card details
    driver.find_element_by_xpath(
        "//input[@type='tel'][@placeholder='Card number']").send_keys('378282246310005')
    driver.find_element_by_xpath(
        "//input[@type='tel'][@placeholder='MM / YY']").send_keys('0921')
    driver.find_element_by_xpath(
        "//input[@type='tel'][@placeholder='CVC']").send_keys('1357')
    driver.find_element_by_xpath(
    ...
    # enter phone number
    driver.find_element_by_xpath(
        "//input[@type='tel'][@autocomplete='mobile tel']").send_keys('2468135790')
